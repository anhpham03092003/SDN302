...
function IndividualTaskDetail({ show, setShow }) {
    return (
        <Modal
            show={show}
            size="xl"
            ...
            <Modal.Body className='vh-83 overflow-auto'>
                <Container>
                    <Row className='d-flex justify-content-between'>
                        <Col md={8}>
                            <Row className='mb-3'>
                                <Col md={8} className='align-content-center'><p className='m-0'>in the <strong className='text-success '>TODO</strong></p></Col>
                            ...
                            <Row className='mb-3'>
                                ...
                                <Row className='ms-4'>
                                    <Col md={12}><IndividualSubTask /></Col>
                                    <Col md={12}><IndividualSubTask /></Col>
                                    <Col md={12}><IndividualSubTask /></Col>
                                    <Col md={12}><IndividualSubTask /></Col>
                                    <Col md={12}><IndividualSubTask /></Col>
